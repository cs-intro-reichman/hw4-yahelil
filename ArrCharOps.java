...
public class ArrCharOps {
    ...
    public static int lastIndexOf(char[] arr, char ch) {
        int last_index_char = -1;
        for (int i = 0; i<arr.length; i++){
            if (charAt(arr, i) == ch){
                last_index_char = i;
            }
        }
        return last_index_char;
    }
    ...
    */
    public static char[] concat(char[] arr1, char[] arr2) {
        ...
        for (int i = 0; i<arr2.length;i++){
            concat_arr[i+arr1.length] = arr2[i];
        }
        return concat_arr;
    }
    ...
    public static char[] subArray(char[] arr, int beginIndex, int endIndex) {
        int subarrat_length = endIndex-beginIndex;
        char[] sub_arr = new char[subarrat_length];
        for (int i = 0; i<subarrat_length;i++){
            sub_arr[i] = arr[i+beginIndex];
        }
        return sub_arr;
    }
